...
puts 'Creating 10 road bikes...'
  ...
  10.times do
    bike = Bike.new(
      ...
      user_id: [1..50].sample,
      price: [70..300].sample,
      photo: "https://res.cloudinary.com/lluz/image/upload/#{road_10pics[increment]}"
    )
    bike.save!
    increment += 1
  end
...
puts 'Creating 10 mtb bikes...'
  ...
  10.times do
    bike = Bike.new(
      ...
      user_id: [1..50].sample,
      price: [70..300].sample,
      photo: "https://res.cloudinary.com/lluz/image/upload/#{mtb_10pics[increment]}"
    )
    bike.save!
    increment += 1
  end
...
puts 'Creating 10 fixie/singlespeed bikes...'
  ...
  10.times do
    bike = Bike.new(
      ...
      user_id: [1..50].sample,
      price: [70..300].sample,
      photo: "https://res.cloudinary.com/lluz/image/upload/#{fixie_10pics[increment]}"
    )
    bike.save!
    increment += 1
  end
...
puts 'Creating 10 city bikes...'
  ...
  10.times do
    bike = Bike.new(
      ...
      user_id: [1..50].sample,
      price: [70..300].sample,
      photo: "https://res.cloudinary.com/lluz/image/upload/#{city_10pics[increment]}"
    )
    bike.save!
    increment += 1
  end
...
puts 'Creating 5 bmx bikes...'
  ...
  5.times do
    bike = Bike.new(
      ...
      user_id: [1..50].sample,
      price: [70..300].sample,
      photo: "https://res.cloudinary.com/lluz/image/upload/#{bmx_5pics[increment]}"
    )
    bike.save!
    increment += 1
  end
...
puts 'Creating 5 cargo bikes...'
  ...
  5.times do
    bike = Bike.new(
      ...
      user_id: [1..50].sample,
      price: [70..300].sample,
      photo: "https://res.cloudinary.com/lluz/image/upload/#{cargo_5pics[increment]}"
    )
    bike.save!
    increment += 1
  end
